...
export default function LazyTrading() {
  ...
  // Check if user wants to skip landing (via URL param or if already authenticated and in progress)
  useEffect(() => {
  ...
  const handleGetStarted = () => {
    ...
    window.history.replaceState(null, "", "/lazy-trading?setup=true");
  };
  ...
  if (showLanding) {
    return (
      <div className="min-h-screen" style={{ background: theme.bg }}>
        ...
        <LazyTradingLanding onGetStarted={handleGetStarted} />
        <OstiumFooter />
      </div>
    );
  }
